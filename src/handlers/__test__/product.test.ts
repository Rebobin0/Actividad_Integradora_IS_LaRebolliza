...
describe('POST /api/products', () => {
    ...
    it('should display validatte that the price is greater  than 0', async () => {
        const response = await request(server).post('/api/products').send({
    ...
    it('should display validatte that the price is a number', async () => {
        const response = await request(server).post('/api/products').send({
            name: "Monitor testing",
            price: "hola"
        })
...
describe('GET /api/products/:id', () => {
    ...
    it('GET a json response for a single prodcut', async () => {
